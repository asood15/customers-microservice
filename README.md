...
### Assumptions
1. A defaulz schema.sql and data.sql are present in the src/main/resources. schema.sql creates the table and data.sql populates withfive default records. Hibernate ddl is set to false to allow schema.sql script to run
...
4. Data Transfer Object is used to send customerDetails as a response of the API. For login and update endpoints other models are used to provide loose coupling
...
2. To retrieve a customer based on uuid http://localhost:8080/customers/{customerUuid}
